...
$sql="UPDATE tblusers SET emailOtp=:otp , userPassword= :npassword WHERE emailId=:emailid";
...
smtp_mailer($email,"PHP OTP LOGIN",$otp);
echo "<script>alert('Email successfully Very OTP generate in your email');</script>";	
